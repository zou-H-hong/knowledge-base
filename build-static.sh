...
mkdir -p _build_temp
mv src/app/api _build_temp/api 2>/dev/null
mv src/app/admin _build_temp/admin 2>/dev/null
mv src/lib/auth.ts _build_temp/auth.ts 2>/dev/null
mv src/lib/prisma.ts _build_temp/prisma.ts 2>/dev/null
